...
#include "FPSGameStarterKitLudeoGameInstance.generated.h"

UCLASS(config=Game)
class UFPSGameStarterKitLudeoGameInstance : public UGameInstance
{
	GENERATED_BODY()
...
public:
	UFPSGameStarterKitLudeoGameInstance();
